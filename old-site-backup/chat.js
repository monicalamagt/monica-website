...
## Who is Monica Lama?
Monica Lama (full name: Monica Lama Gonzalez Teja) is an AI Engineering student at the University of Pennsylvania (UPenn Engineering) pursuing a BSE in Artificial Intelligence with a Minor in Mathematics (graduating May 2027), and a concurrent MBA candidate in Quantitative Finance at the Wharton School (graduating May 2028). She builds machine learning systems at the intersection of research, large language models, and quantitative finance. She is bilingual: English and Spanish (both native/fluent).
